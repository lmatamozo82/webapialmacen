...
namespace WebAPIAlmacen.Migrations
{
    ...
    [Migration("20220607105836_usuarios")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPIAlmacen.Entidades.ProductoKeyLess", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToSqlQuery("SELECT Id, Nombre, Precio from Productos");
                });
            ...
            modelBuilder.Entity("WebAPIAlmacen.Entidades.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebAPIAlmacen.Entidades.DistribuidorProducto", b =>
                {
                    b.HasOne("WebAPIAlmacen.Entidades.Distribuidor", "Distribuidor")
                        .WithMany("DistribuidorProductos")
            ...
            modelBuilder.Entity("WebAPIAlmacen.Entidades.Distribuidor", b =>
                {
                    b.Navigation("DistribuidorProductos");
                });
